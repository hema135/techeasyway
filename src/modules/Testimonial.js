            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mobile-bottom-fix-big"
                    ...
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="../../public/assets/images/testimonial-author-1.png" alt="Second Author" /></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="../../public/assets/images/testimonial-author-1.png" alt="Author Third" /></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="../../public/assets/images/testimonial-author-1.png" alt="Fourth Author" /></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
